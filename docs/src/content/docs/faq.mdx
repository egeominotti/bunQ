...
description: 'Common questions about bunqueue answered: SQLite, PostgreSQL 15–18 multi-broker mode, embedded vs server, performance, retries, scaling, backups, and migration.'
head:
  - tag: meta
    attrs:
      property: og:image

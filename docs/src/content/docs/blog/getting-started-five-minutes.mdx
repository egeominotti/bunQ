---
title: "Quick Start: Build a Bun Job Queue in 5 Minutes"
...
head:
  - tag: meta
    attrs:
      property: og:image
      content: https://bunqueue.dev/og/blog/getting-started-five-minutes.png
  - tag: meta
    attrs:
      property: og:type
      content: article
...
<div class="bq-wrap bq-hero">
  <span class="bq-eyebrow">blog · quick start</span>
  <h1 class="bq-hero-h1 bq-bench-h1">Background jobs in five <em>minutes.</em></h1>
  <p class="bq-hero-sub">From zero to processing jobs before your coffee cools. This guide covers embedded mode, the simplest setup, and TCP server mode for distributed systems.</p>
</div>

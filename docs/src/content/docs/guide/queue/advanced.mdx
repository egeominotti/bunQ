...
<div class="bq-wrap bq-hero">
  ...
  <h1 class="bq-hero-h1 bq-bench-h1">
    Sharing a server, <em>and leaving it.</em>
  </h1>
  <p class="bq-hero-sub">
    Namespacing so several environments can share one broker, batching that makes concurrent adds an
    order of magnitude faster, and draining an edge queue into a central one.
  </p>
</div>

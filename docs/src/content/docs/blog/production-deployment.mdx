...
<div class="bq-wrap bq-hero">
  ...
  <p class="bq-hero-sub">bunqueue is a single-instance queue by design: no clustering, no leader election, no split-brain. That makes deployment simple, and this guide covers doing it reliably with Docker, systemd, and PM2.</p>
</div>

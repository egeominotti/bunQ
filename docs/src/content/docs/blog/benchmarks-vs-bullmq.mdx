...
<CardGrid>
  ...
  <Card title="91% Smaller Install" icon="laptop">
    **8.2 MB vs 93 MB** — 7 packages, no Redis server required
  </Card>
</CardGrid>
...
|--------|----------|--------------|--------|
| `node_modules` size | 8.2 MB | 93 MB | **−91%** |
| packages installed | 7 | 117 | **−94%** |
| cold install time | 0.72 s | 2.73 s | **3.8x faster** |

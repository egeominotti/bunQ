...
<div class="bq-wrap bq-hero">
  ...
  <p class="bq-hero-sub">A crashed worker cannot tell anyone. Heartbeats let the queue notice, and locks make sure the recovered job is picked up by exactly one replacement.</p>
</div>

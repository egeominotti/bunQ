---
title: "Auto-Batching: Up to 10x Throughput, Zero Code Changes"
description: "How bunqueue transparently batches concurrent add() calls into bulk operations. Get up to 10x throughput in Bun with no code changes required."
head:
  - tag: meta
    attrs:
      property: og:image
      content: https://bunqueue.dev/og/blog/auto-batching.png
  - tag: meta
    attrs:
      property: og:type
      content: article

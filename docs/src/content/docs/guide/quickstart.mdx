...
*Rust and Elixir have no worker event emitter: use the structured telemetry callback for transport lifecycle and normal language control flow for per-job outcomes (see the [SDK guide](/guide/sdks/)).*

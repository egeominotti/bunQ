...
<div class="bq-wrap bq-hero">
  ...
  <h1 class="bq-hero-h1 bq-bench-h1">
    The schedules you <em>actually need.</em>
  </h1>
  <p class="bq-hero-sub">
    Three shapes cover almost every recurring job: a fixed interval, a wall-clock time in a real
    timezone, and a job that re-arms itself only once the previous run finished.
  </p>
</div>

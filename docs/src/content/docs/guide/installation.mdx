...
<div class="bq-wrap bq-hero">
  ...
  <h1 class="bq-hero-h1 bq-bench-h1">
    Install bunqueue, zero <em>infrastructure.</em>
  </h1>
  <p class="bq-hero-sub">
    One command installs the library, standalone server, and CLI. Embedded SQLite needs no external
    service; PostgreSQL is available when you choose a multi-broker deployment. Redis is never
    required.
  </p>
</div>

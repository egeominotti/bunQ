...
<div class="bq-wrap bq-hero">
  ...
  <h1 class="bq-hero-h1 bq-bench-h1">
    Getting work <em>into the queue.</em>
  </h1>
  <p class="bq-hero-sub">
    One job or a hundred thousand, ordered by priority, held back by a delay, or written straight to
    disk when losing it is not an option.
  </p>
</div>
...
`addBulk` is ordered and uses accepted-prefix semantics; it is not an

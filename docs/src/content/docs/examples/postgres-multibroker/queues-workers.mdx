...
<div class="bq-wrap bq-hero">
  ...
  <h1 class="bq-hero-h1 bq-bench-h1">
    N queues. N workers. <em>One truth.</em>
  </h1>
  <p class="bq-hero-sub">
    Put producers on broker A, workers on B and C, and observers on C. PostgreSQL keeps jobs,
    policies, lifecycle state, events, logs, and results coherent across the fleet.
  </p>
</div>

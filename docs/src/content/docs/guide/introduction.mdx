...
<div class="bq-wrap bq-hero">
  ...
  <h1 class="bq-hero-h1 bq-bench-h1">One process locally. <em>Many brokers when needed.</em></h1>
  <p class="bq-hero-sub">bunqueue is a job queue for the Bun runtime. Start embedded in memory or with one SQLite file, or run standalone servers against PostgreSQL 15–18 when several brokers must share one authoritative queue. No Redis is required.</p>
</div>

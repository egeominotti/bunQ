...
description: "The bunqueue Queue is the producer side: create it embedded in your process or pointed at a server, then add, inspect and control jobs backed by SQLite."
head:
  - tag: meta
    attrs:
      property: og:image
...
<div class="bq-wrap bq-hero">
  ...
  <p class="bq-hero-sub">A Queue is where work goes in. Same object whether it writes straight to a SQLite file in your process or talks to a shared server over TCP, so the code you write does not change when the deployment does.</p>
</div>

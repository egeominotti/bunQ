...
head:
  - tag: meta
    attrs:
      property: og:image
      content: https://bunqueue.dev/og/blog/benchmarks-vs-bullmq.png
  - tag: meta
    attrs:
      property: og:type
      content: article
...
<div class="bq-wrap bq-hero">
  ...
  <h1 class="bq-hero-h1 bq-bench-h1">
    bunqueue vs BullMQ, <em>measured.</em>
  </h1>
  <p class="bq-hero-sub">
    Performance claims without numbers are just marketing. These are reproducible benchmarks of
    bunqueue TCP against BullMQ with Redis on identical workloads, both over real network
    connections.
  </p>
</div>
...
<div class="bq-cards">
  <div class="bq-card">
    ...
    <p>
      <b>85,700 vs 24,800 ops/sec</b> - Bulk push (100 jobs per batch)
    </p>
  </div>
  <div class="bq-card">
    <BqIcon name="speed" />
    ...
    <p>
      <b>6.3ms vs 11.1ms</b> - Bulk push p99 latency
    </p>
  </div>
  <div class="bq-card">
    <BqIcon name="stack" />
    ...
    <p>
      <b>52,756 vs 56,736 ops/sec</b> - BullMQ slightly ahead, effectively a tie
    </p>
  </div>
  <div class="bq-card">
    <BqIcon name="file" />
    ...
    <p>
      <b>5.5 MB vs 93 MB</b>, 7 packages, no Redis server required
    </p>
  </div>
</div>
...
PostgreSQL 18.6 multi-broker backend, but this benchmark did not measure it and

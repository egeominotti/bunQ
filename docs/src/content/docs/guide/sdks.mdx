---
title: "bunqueue SDKs: Node.js, Deno, Python & Cloudflare Workers"
...
|---|---|---|---|
| Node.js ≥ 20, Bun, Deno ≥ 2, Cloudflare Workers | `bunqueue-client` | 0.1.7 | [npm](https://www.npmjs.com/package/bunqueue-client) · [source](https://github.com/egeominotti/bunqueue/tree/main/sdk/typescript) |
| Python ≥ 3.9 | `bunqueue-client` | 0.1.2 | PyPI upcoming, [installable from the repository](https://github.com/egeominotti/bunqueue/tree/main/sdk/python) today |

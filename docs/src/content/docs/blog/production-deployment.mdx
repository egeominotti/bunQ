---
title: "Deploying bunqueue to Production"
description: "Production deployment patterns for bunqueue with Docker, systemd, and PM2. Health checks, resource limits, backup strategies, and monitoring setup."
head:
  - tag: meta
    attrs:
      property: og:image
...
HEALTHCHECK --interval=30s --timeout=5s --start-period=10s --retries=3 \
  CMD wget -qO- http://127.0.0.1:6790/health || exit 1

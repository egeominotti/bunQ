...
| Python ≥ 3.9 | `bunqueue-client` | PyPI upcoming, [install from the repository](https://github.com/egeominotti/bunqueue/tree/main/sdk/python) today |
| PHP ≥ 8.1 | `bunqueue/client` | Packagist upcoming, [source](https://github.com/egeominotti/bunqueue/tree/main/sdk/php) |
| Go ≥ 1.26.5 | `github.com/egeominotti/bunqueue/sdk/go` | `go get`, [source](https://github.com/egeominotti/bunqueue/tree/main/sdk/go) |
| Rust ≥ 1.85 | `bunqueue-client` | crates.io upcoming, [source](https://github.com/egeominotti/bunqueue/tree/main/sdk/rust) |

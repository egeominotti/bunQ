---
title: "Running bunqueue in Production: Failure Semantics, Backups & Operations"
description: What a bunqueue deployment actually costs to operate and what survives failure. Crash semantics, at-least-once delivery, ACK fencing, S3 backups, WAL growth, monitoring, graceful shutdown.
template: splash
head:
  - tag: meta
    attrs:

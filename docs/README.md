...
| [Executable PostgreSQL Multi-Broker Example](../examples/postgres-multibroker/README.md)                    | Disposable PostgreSQL 18.6 plus three-broker Compose topology and public-SDK scenarios for health/auth, N queues and workers, retries/DLQ/shared limits, and durable cross-queue flows, with teardown built into the verifier.                                                |

---
title: "Reliable Bun Workers: Stall Detection, Heartbeats"
...
head:
  - tag: meta
    attrs:
      property: og:image
      content: https://bunqueue.dev/og/blog/reliable-workers.png
  - tag: meta
    attrs:
      property: og:type
      content: article
...
<div class="bq-wrap bq-hero">
  ...
  <h1 class="bq-hero-h1 bq-bench-h1">Workers crash. Jobs <em>survive.</em></h1>
  <p class="bq-hero-sub">A queue is only as reliable as its workers. When one dies mid-processing, the job must not be lost or stuck active forever. bunqueue solves this with stall detection, heartbeats, and lock-based ownership.</p>
</div>

...
<div class="bq-wrap bq-hero">
  ...
  <h1 class="bq-hero-h1 bq-bench-h1">
    Dead jobs, from <em>the producer side.</em>
  </h1>
  <p class="bq-hero-sub">
    The Queue object carries the DLQ surface too, so the process that produces work can also
    configure and drain the pile of work that failed.
  </p>
</div>

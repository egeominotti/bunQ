#!/usr/bin/env bun
/**
 * Run All WebSocket/SSE Functional Tests
...
const TCP_PORT = 26789; // Unique port to avoid conflicts with TCP tests
const HTTP_PORT = 26790;
...
async function main() {
  console.log('╔════════════════════════════════════════════════════════════╗');
  console.log('║       bunqueue WebSocket/SSE Functional Test Suite        ║');
  console.log('╚════════════════════════════════════════════════════════════╝\n');
  ...
  try {
    ...
    for (const file of testFiles) {
      ...
      results.push({ name: result.name, success: result.success, passed, failed });
    ...
    if (failedTests > 0) {
      ...
      console.log('\n✅ All WebSocket/SSE tests passed!\n');
      process.exit(0);
    }
  } catch (e) {

...
<div class="bq-wrap bq-hero">
  ...
  <p class="bq-hero-sub">One command installs the library, standalone server, and CLI. Embedded SQLite needs no external service; PostgreSQL is available when you choose a multi-broker deployment. Redis is never required.</p>
</div>

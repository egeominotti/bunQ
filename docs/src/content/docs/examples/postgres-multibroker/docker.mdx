...
<div class="bq-wrap bq-hero">
  ...
  <h1 class="bq-hero-h1 bq-bench-h1">
    PostgreSQL plus <em>three active brokers.</em>
  </h1>
  <p class="bq-hero-sub">
    A local topology that behaves like a broker fleet: private east-west traffic, unique broker
    identities, readiness gates, loopback-only host ports, and no bind mounts.
  </p>
</div>

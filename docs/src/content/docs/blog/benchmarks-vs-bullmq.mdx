...
<div class="bq-cards">
  <div class="bq-card">
    ...
    <p><b>54,140 vs 43,261 ops/sec</b> - Single job push operations</p>
  </div>
  <div class="bq-card">
    <BqIcon name="spark" />
    <h3>3.2x Faster Bulk</h3>
    <p><b>139,200 vs 44,000 ops/sec</b> - Bulk push (100 jobs per batch)</p>
  </div>
  <div class="bq-card">
    <BqIcon name="stack" />
    <h3>1.7x Faster Processing</h3>
    <p><b>17,300 vs 10,200 ops/sec</b> - Full push-process-complete cycle</p>
  </div>
  <div class="bq-card">
    <BqIcon name="file" />
    <h3>94% Smaller Install</h3>
    <p><b>5.4 MB vs 93 MB</b>, 7 packages, no Redis server required</p>
  </div>
</div>

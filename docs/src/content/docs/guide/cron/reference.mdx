...
<div class="bq-wrap bq-hero">
  ...
  <h1 class="bq-hero-h1 bq-bench-h1">
    Every field, every <em>option.</em>
  </h1>
  <p class="bq-hero-sub">
    The expression syntax with its shortcuts, the full repeat option table with defaults and the
    naming each SDK uses, plus managing schedules through an AI agent.
  </p>
</div>

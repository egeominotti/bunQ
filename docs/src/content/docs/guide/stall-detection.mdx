...
<div class="bq-wrap bq-hero">
  ...
  <div class="bq-proof">
    <span><b>30s+</b> of heartbeat silence marks a job stalled (confirmed over two 5s sweeps, so ~30–40s in practice)</span>
...
roughly `stallInterval` plus one to two sweeps (~30–40s at the defaults).

---
title: "Job Queue Rate Limiting & Concurrency Control in Bun"
description: "Protect downstream services with bunqueue's rate limiting and concurrency controls. Per-queue limits, global concurrency, and backpressure."
head:
  - tag: meta
    attrs:
      property: og:image
      content: https://bunqueue.dev/og/blog/rate-limiting-concurrency.png
  - tag: meta
    attrs:
      property: og:type
      content: article

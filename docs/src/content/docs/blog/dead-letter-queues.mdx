---
title: "Dead Letter Queues: Catch, Inspect, Retry"
...
<div class="bq-wrap bq-hero">
  ...
  <h1 class="bq-hero-h1 bq-bench-h1">Where failed jobs go to be <em>fixed.</em></h1>
...
A processing timeout counts as a failed attempt, so a job that keeps timing out also ends up in the DLQ with reason `max_attempts_exceeded` once its attempts run out.
...
// with reason: 'max_attempts_exceeded'
```

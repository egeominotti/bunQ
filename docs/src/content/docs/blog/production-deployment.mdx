---
title: 'Deploy to Production: Docker, systemd and PM2'
...
head:
  - tag: meta
    attrs:
      property: og:image
      content: https://bunqueue.dev/og/blog/production-deployment.png
  - tag: meta
    attrs:
      property: og:type
      content: article
...
<div class="bq-wrap bq-hero">
  ...
  <h1 class="bq-hero-h1 bq-bench-h1">
    One instance, deployed <em>properly.</em>
  </h1>
  <p class="bq-hero-sub">
    This article covers bunqueue's default single-instance SQLite deployment with Docker, systemd,
    and PM2. PostgreSQL 15–18 multi-broker mode is now also available, with 18.6 recommended; follow
    the current deployment guide for that topology.
  </p>
</div>

...
description: "Discover why bunqueue uses SQLite instead of Redis for job queues on Bun. Simpler deployments, zero external services, and 100k jobs/sec throughput."
head:
  - tag: meta
    attrs:
      property: og:image
